...
from model.net import XNMNet, XNMNet_LMH, XNMNet_semantic
...
if __name__ == '__main__':
    ...
    args.val_feature_h5 = os.path.join(args.feature_dir, args.val_feature_h5)
    ...
    elif args.mode == 'test': # XNM test script, not used in our experiments
